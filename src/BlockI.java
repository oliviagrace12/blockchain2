...
class BlockRecord2{
    ...
    /* Examples of accessors for the BlockRecord2 fields: */
...
/*  Starting point for the BlockRecord2:
...
public class BlockI {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            JAXBContext jaxbContext = JAXBContext.newInstance(BlockRecord2.class);
	 ...
	 verification test. */
            ...
            BlockRecord2 blockRecord2 = (BlockRecord2) jaxbUnmarshaller.unmarshal(reader);
